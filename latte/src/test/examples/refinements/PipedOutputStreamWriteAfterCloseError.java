...
public class PipedOutputStreamWriteAfterCloseError {
    public static class PipedOutputStream {
        ...
        @StateRefinement(
            from = "this.isConnected == false && this.isClosed == false && sink.isConnected == false && sink.isClosed == false",
    ...
    public static class PipedInputStream {
        ...
        @StateRefinement(
            from = "this.isConnected == false && this.isClosed == false && source.isConnected == false && source.isClosed == false",
